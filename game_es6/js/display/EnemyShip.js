SF.EnemyShip = class EnemyShip extends SF.AbstractShip {
  constructor(baseTexture) {
    super(baseTexture, SF.LightBeam.Type.Red);
  ...
  reset(state) {
    ...
    const gameAreaConfig = SF.Config.gameArea;
    ...
    const bodyStyle = getRandomFromArray(Math.random(), SF.EnemyShip.BodyStyles);
